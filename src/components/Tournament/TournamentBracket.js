...
function TournamentBracket(props) {
  ...
  useEffect(() => {
    setFightersR1(['Grover','Benton','Neal','Caitlin','Daryl','Ina','Preston','Ellen','Johnnie','Francisco','Theodore','Domingo','Williams','Adrian','Alyce','Ryan','Consuelo','Tommie','John','Landon','Mervin','Joyce','Conrad','Vince','Jermaine','Frank','Julia','Debra','Wallace','Bernie','Lazaro','Elisa','Brenton','Lowell','Owen','Rodolfo','Ramona','Blake','Eliseo','Geneva','Ricardo','Hector','Benita','Mildred','Morton','Derek','Hester','Thomas','Leta','Gaston','Vicki','Mamie','Amelia','Jose','Amalia','Fredric','Cindy','William','Ladonna','Rhea','Rupert','Everette','Michael','Loren',])
    ...
    if(i % 2 === 0){
      return  <div className='bracket-round-one'>
                <svg height='100%' width='100%'>
                  <path d='M5 5 h160 v50 h-160' fill='none' stroke-width='4' stroke='whitesmoke' strokeLinejoin='bevel'></path>
                </svg>
              </div>
    }
  })
  let bracketRoundTwo = fightersR1.map((el, i) => {
    if(i % 4 === 0){
      return  <div className='bracket-round-two'>
                <svg height='100%' width='100%'>
                  <path d='M5 5 h160 v100 h-160' fill='none' stroke-width='4' stroke='whitesmoke' strokeLinejoin='bevel'></path>
                </svg>
              </div>
    }
  })
  let bracketRoundThree = fightersR1.map((el, i) => {
    if(i % 8 === 0){
      return  <div className='bracket-round-three'>
                <svg height='100%' width='100%'>
                  <path d='M5 5 h160 v200 h-160' fill='none' stroke-width='4' stroke='whitesmoke' strokeLinejoin='bevel'></path>
                </svg>
              </div>
    }
  })
  let bracketRoundFour = fightersR1.map((el, i) => {
    if(i % 16 === 0){
      return  <div className='bracket-round-four'>
                <svg height='100%' width='100%'>
                  <path d='M5 5 h160 v400 h-160' fill='none' stroke-width='4' stroke='whitesmoke' strokeLinejoin='bevel'></path>
                </svg>
              </div>
    }
  })
  let bracketRoundFive = fightersR1.map((el, i) => {
    if(i % 32 === 0){
      return  <div className='bracket-round-five'>
                <svg height='100%' width='100%'>
                  <path d='M5 5 h160 v800 h-160' fill='none' stroke-width='4' stroke='whitesmoke' strokeLinejoin='bevel'></path>
                </svg>
              </div>
    }
  })
  let bracketRoundSix = fightersR1.map((el, i) => {
    if(i % 64 === 0){
      return  <div className='bracket-round-six'>
                <svg height='100%' width='100%'>
                  <path d='M5 5 h160 v1600 h-160' fill='none' stroke-width='4' stroke='whitesmoke' strokeLinejoin='bevel'></path>
                </svg>
              </div>
    }
  })
  let bracketRoundSeven = fightersR1.map((el, i) => {
    if(i % 64 === 0){
      return  <div className='bracket-round-seven'>
                <svg height='100%' width='100%'>
                  <path d='M5 5 h160' fill='none' stroke-width='4' stroke='whitesmoke' strokeLinejoin='bevel'></path>
                </svg>
              </div>
    }
  })
  ...
  let fightersRoundThree = fightersR3.map((name, i) => {
    ...
    if(name === '') return <div className='fighters-round-three'></div>
      ...
      return  <div className='fighters-round-three'>
                <img  src={fightersImg[i]} alt=''
                      onClick={() => advanceFighter(i, round)}
                      className='fighter-img' />
                <p>{name}</p>
  ...
  let fightersRoundFour = fightersR4.map((name, i) => {
    ...
    if(name === '') return <div className='fighters-round-four'></div>
      ...
      return  <div className='fighters-round-four'>
                <img  src={fightersImg[i]} alt=''
                      onClick={() => advanceFighter(i, round)}
                      className='fighter-img' />
                <p>{name}</p>
  ...
  let fightersRoundFive = fightersR5.map((name, i) => {
    ...
    if(name === '') return <div className='fighters-round-five'></div>
      ...
      return  <div className='fighters-round-five'>
                <img  src={fightersImg[i]} alt=''
                      onClick={() => advanceFighter(i, round)}
                      className='fighter-img' />
                <p>{name}</p>
  ...
  let fightersRoundSix = fightersR6.map((name, i) => {
    ...
    if(name === '') return <div className='fighters-round-six'></div>
      ...
      return  <div className='fighters-round-six'>
                <img  src={fightersImg[i]} alt=''
                      onClick={() => advanceFighter(i, round)}
                      className='fighter-img' />
                <p>{name}</p>
  ...
  let fightersRoundSeven = fightersR7.map((name, i) => {
    ...
    if(name === '') return <div className='fighters-round-seven'></div>
      ...
      return  <div className='fighters-round-seven'>
                <img  src={fightersImg[i]} alt=''
                      onClick={() => advanceFighter(i, round)}
                      className='fighter-img' />
                <p>{name}</p>
